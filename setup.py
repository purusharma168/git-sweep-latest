...
if os.path.exists(os.path.join(here, 'README.rst')):  # Change to README.rst
...
setup(
    name='git-sweep-latest',  # Update the package name
    version=version,
    description="Clean up branches from your Git remotes",
    long_description=README + '\n\n' + NEWS,
    long_description_content_type='text/x-rst',  # Change to text/x-rst for RST
    classifiers=[
